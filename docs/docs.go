...
const docTemplate = `{
    ...
    "paths": {
        "/api/v1/exchange-configs": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/exchangeconfig.ExchangeConfig"
                                            }
                                        },
                                        "meta": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Exchange config",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/exchangeconfig.CreateExchangeConfigRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/exchange-configs/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Exchange Config ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/exchangeconfig.UpdateExchangeConfigRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/storage/audit/{tenant_id}": {
            "get": {
        ...
        "/api/v1/storage/decisions/risk/{instance_id}": {
            "get": {
        ...
        "/api/v1/storage/decisions/strategy/{instance_id}": {
            "get": {
        ...
        "/api/v1/storage/opportunities/{id}": {
            "get": {
        ...
        "/api/v1/storage/retention/cleanup": {
            "post": {
    ...
    "definitions": {
        ...
        "exchangeconfig.CreateExchangeConfigRequest": {
            "type": "object",
            "required": [
                "exchange_name",
                "rest_base_url",
        ...
        "exchangeconfig.ExchangeConfig": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/exchangeconfig.ExchangeConfigStatus"
                },
                "timeout_ms": {
                    "type": "integer"
                },
        ...
        "exchangeconfig.ExchangeConfigStatus": {
            "type": "string",
            "enum": [
                "ACTIVE",
                "DISABLED"
            ...
            "x-enum-varnames": [
                "ExchangeConfigStatusActive",
                "ExchangeConfigStatusDisabled"
            ]
        },
        "exchangeconfig.UpdateExchangeConfigRequest": {
            "type": "object",
            "properties": {
                "exchange_name": {
                    "type": "string"
